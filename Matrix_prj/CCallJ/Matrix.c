...
int main(int argc, char **argv)
{
	...
	//Call java
	jclass jmatrixclass;
    	jmatrixclass = (*env)->FindClass(env,"MatrixUtil");
	
	jmethodID constructId;
	constructId = (*env)->GetMethodID(env, jmatrixclass, "<init>", "()V");
	jobject jutilobject = (*env)->NewObject(env, jmatrixclass, constructId);
	
	jmethodID multiplyMethodId;
	multiplyMethodId = (*env)->GetMethodID(env, jmatrixclass, "multiply", "([[I[[IIII)[[I");;
